...
<div class="header">
            ...
            <li><a href="pelajaran.php">Mata Pelajaran</a> <span class="divider">/</span></li>
...
<a href="pelajaran.php" data-toggle="modal" class="btn">Back</a>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">Mata Pelajaran</a></li>
      
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form action="save_pelajaran_after_update.php" method="post" id="save-guru">
    <?php
include 'koneksi.php';
$kode_mapel = $_GET['kode_mapel']; //get the no which will updated
$query = "SELECT * FROM mata_pelajaran WHERE kode_mapel = '$kode_mapel'"; //get the data that will be updated
$hasil = mysql_query($query);
$data = mysql_fetch_array($hasil);
?>
        <label>Kode Mapel</label>
        <input name="kode_mapel" type="text" class="input-xlarge" value="<?php echo $data['kode_mapel']; ?>" >
        <label>Nama MataPelajaran</label>
        <input name="nama_mapel" type="text" class="input-xlarge" id="nama" value="<?php echo $data['nama_mapel']; ?>">
    </form>
      </div>
