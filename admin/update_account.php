...
$querys = "SELECT * FROM admin WHERE username='$dd'";
        ...
        <input name="NIP" type="text" class="input-xlarge" value="<?php echo $b; ?>">
        <label>Last Name</label>
        <input name="nama" type="text" class="input-xlarge" id="nama" value="<?php echo $c; ?>">
        <label>Username</label>
        <input type="text" value="<?php echo $d; ?>" class="input-xlarge">
    </form>
      </div>
