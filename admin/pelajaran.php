...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">Pelajaran</a></li>
      <li><a href="#profile" data-toggle="tab">Mata Pelajaran</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form action="savepelajaran.php" method="post" id="save-pendaftaran">
        <label>Kode</label>
        <input name="kode_mapel" type="text" class="input-xlarge" placeholder="Contoh : 10TIK" >
        <label>Mata Pelajaran</label>
        <input name="nama_mapel" type="text" class="input-xlarge" placeholder="Contoh : Teknologi Informasi" id="nama">
    </form>
    <div>
         <div class="well">
        <table class="table">
...
var delpath = 'remove_pelajaran.php?kode_mapel='+$(this).attr('data-id');
