...
<div class="well">
    ...
    <form action="savepelajaran.php" method="post" id="save-pendaftaran">
        <label>Kode</label>
        <input name="kode_mapel" type="text" class="input-xlarge" placeholder="10TIK" >
        <label>Mata Pelajaran</label>
        <input name="nama_mapel" type="text" class="input-xlarge" placeholder="Teknologi Informasi" id="nama">
    </form>
    <div>
         <div class="well">
        <table class="table">
