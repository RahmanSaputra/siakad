...
<div class="header">
            ...
            <li><a href="users.html">Guru</a> <span class="divider">/</span></li>
...
<a href="guru.php" data-toggle="modal" class="btn">Back</a>
...
<div class="well">
    ...
    <form action="save_guru_after_update.php" method="post" id="save-guru">
    <?php
include 'koneksi.php';
$NIP = $_GET['NIP']; //get the no which will updated
$query = "SELECT * FROM guru WHERE NIP = $NIP"; //get the data that will be updated
$hasil = mysql_query($query);
$data = mysql_fetch_array($hasil);
?>
        <label>NIP</label>
        <input name="NIP" type="text" class="input-xlarge" value="<?php echo $data['NIP']; ?>" readonly="readonly">
        <label>Nama</label>
        <input name="nama" type="text" class="input-xlarge" id="nama" value="<?php echo $data['nama']; ?>">
        <label>Jabatan</label>
        <input type="text" disabled value="<?php echo $data['jabatan']; ?>" class="input-xlarge">
        <label>Alamat</label>
        ...
        <label>Kelamin</label>
        <input name="kelamin" type="text" disabled value="<?php echo $data['kelamin']; ?>" class="input-xlarge">
        <label>Email</label>
        <input name="email" type="text" value="<?php echo $data['email']; ?>" class="input-xlarge">
    </form>
      </div>
