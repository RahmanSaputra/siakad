...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab">Data Pendaftaran</a></li>
    </ul>
   ...
   include 'koneksi.php';
    $query = $_POST['search'];
    $sql = mysql_query("SELECT * FROM pendaftaran WHERE nama LIKE '%{$query}%'");
    $array = array();
...
<div class="pagination">
    <ul>
        <li><a href="pendaftaran.php"><-- Back</a></li>
    </ul>
</div>
